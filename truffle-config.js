...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: function () {
        return new HDWalletProvider([process.env.PRIVATE_KEY], `wss://ropsten.infura.io/ws/v3/${process.env.PROJECT_ID}`)
      },
      network_id: 3,  
      gas: 8000000,
    ...
    mumbai: {
      provider: function () {
        return new HDWalletProvider([process.env.PRIVATE_KEY], `https://matic-mumbai.chainstacklabs.com`)
      },
      network_id: 80001,  
      gas: 8000000,
      gasPrice: 10000000000,
